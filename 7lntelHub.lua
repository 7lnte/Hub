...
local settings = {ui_bind="Enum.KeyCode.RightControl",opaque=0.4};
...
if not everyClipboard then
	getgenv().setclipboard = function(data)
		...
		a:CaptureFocus();
		a = Enum.KeyCode;
		local Keys = {a.RightControl,a.A};
		local Keys2 = {a.RightControl,a.C,a.V};
...
function save()
	if (not isfolder("3067x APEC") and not nosaves) then
		...
		nosaves = true;
		task.wait();
		local update = {ui_bind=settings['ui_bind'],opaque=settings['opaque']};
		task.wait();
		writefile([[3067x APEC/3067x APEC Settings.json]], HttpService:JSONEncode(update));
	end
end
function updatesaves()
	local update = {ui_bind=ui_bind,opaque=opaque};
	writefile("3067x APEC/3067x APEC Settings.json", HttpService:JSONEncode(update));
end
task.wait();
...
elseif (game.PlaceId == 3652625463) then
	...
	if iswave then
		...
		end, {"Enable Fix for file functions","Disable File/Folder functions"});
	end
	...
	DiscordSection:NewButton("Discord Invite", "copys discord link", function()
		if (httprequest and not IsOnMobile) then
			httprequest({Url="http://127.0.0.1:6463/rpc?v=1",Method="POST",Headers={["Content-Type"]="application/json",Origin="https://discord.com"},Body=HttpService:JSONEncode({cmd="INVITE_BROWSER",nonce=HttpService:GenerateGUID(false),args={code="K8BQJ3Rauq"}})});
			Library.Notify("if nothing happened", "Make sure u have discord app open", 5);
		elseif everyClipboard then
			everyClipboard("https://discord.gg/K8BQJ3Rauq");
			Library.Notify("Copied to Clipboard", "", 5);
		else
			Library.Notify("DOG SHIT EXECUTOR", "https://discord.gg/K8BQJ3Rauq", 5);
		end
	end);
	DiscordSection:NewButton("Discord Invite OLD", "Copys Discord invite link", function()
		everyClipboard(string2);
	end);
	local Debugs = Window:NewTab("Home", 10507357657);
	local DebugsSection = Debugs:NewSection("main");
	DebugsSection:NewButton("Debuggers", "GUI อื่น ๆ บางส่วนรวมอยู่ในหนึ่งหรือรวม", function()
	...
	DebugsSection:NewButton("Fling", "Flingall ทำให้ทุกคนตกโลกตาย", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/HootLoop04/adminSSFG/refs/heads/main/flingall"))();
	end);
	...
	AdminsSection:NewButton("CTS", "Dums", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/HootLoop04/adminsss/refs/heads/main/README.md"))();
	end);
	...
	SettingssSection:NewDropdown("UI Toggle Bind", "Changes Toggle Bind for 3067x APEC Default is Right Control ONLY ON PC", {"Right Control","Left Control","Left Alt","Right Alt","Insert","End","Del/Delete","Left Shift","Right Shift","F1","Q","E","R","T","Y","U","P","Z","X","M","V","N","."}, function(currentoption)
	...
	SettingssSection:NewButton("Save Game", "Saves game MUST HAVE saveinstance()", function()
		...
		if (SSSSSS == "Krampus") then
			saveplace({FileName="SkyHubSavedGame",CopyToClipboard=true});
			return;
		end
		if saveplace then
	...
	HubsSection:NewButton("Noob Hub", "Unfair Hub", function()
		loadstring(game:HttpGet("https://pastebin.com/raw/ugg8pnR5", true))();
	end);
	...
	HubsSection:NewButton("Trap Hub", "Trap Hub", function()
		...
		local Games = {AA={FileName=((getgenv().BetaScript and "AnimeAdventures-Rewrite") or "Anime%20Adventures"),PlaceId={3183403065},GameName="Anime Adventures"},RoGhoul={FileName="RoGhoul",PlaceId={380704901},GameName="RoGhoul"},["Blade Ball"]={FileName="BladeBall",PlaceId={4777817887},GameName="Blade Ball"},ASX={FileName="AnimeSouls",PlaceId={5300677688},GameName="Anime Souls Simulator X"},ALS={FileName="AnimeLast",PlaceId={4509896324},GameName="Anime Last"}};
	...
	ObbysSection:NewButton("Method 1", "auto farm/tp to end if supported game", function()
		if (game.PlaceId == 5972698540) then
			game:GetService("StarterGui"):SetCore("SendNotification", {Title="Working",Text="its working just please wait",Icon="",Duration=5,Callback=NotificationBindable});
			wait(15);
		...
		elseif (game.PlaceId == 12357508217) then
			...
			game:GetService("StarterGui"):SetCore("SendNotification", {Title="Game Not Supported",Text="game not supported so it may be trash or not work at all",Icon="",Duration=5,Callback=NotificationBindable});
			...
			elseif game:GetService("Workspace"):FindFirstChild("Stages") then
				...
				game:GetService("StarterGui"):SetCore("SendNotification", {Title="Could not find path",Text="Could not find path including all the stages/checkpoints try the other method",Icon="",Duration=5,Callback=NotificationBindable});
			end
		end
	end);
	ObbysSection:NewButton("Method 2", "fire all touchinterests", function()
		game:GetService("StarterGui"):SetCore("SendNotification", {Title="if this doesnt work for you try method 3",Text="executing in 5 seconds",Icon="",Duration=5,Callback=NotificationBindable});
		wait(5);
	...
	ObbysSection:NewButton("Method 3", "fire all touchinterests pt2", function()
		game:GetService("StarterGui"):SetCore("SendNotification", {Title="if this doesnt work for you join the discord and open a ticket",Text="executing in 5 seconds",Icon="",Duration=5,Callback=NotificationBindable});
		wait(5);
		local ftiamount = 0;
	...
	MainSection:NewButton("Run Criminality", "Infernium", function()
		loadstring(game:HttpGet("https://rawscripts.net/raw/Criminality-Infernium-crack-27249"))();
	end);
	MainSection:NewButton("Run Fisch", "SpeedHub", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/AhmadV99/Speed-Hub-X/main/Speed%20Hub%20X.lua"))();
	end);
	MainSection:NewButton("Run untitled boxing game", "scripts", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/pid4k/scripts/main/untitledboxinggame.lua"))();
	end);
	MainSection:NewButton("Run BlueLock", "FREE SCRIPT", function()
		loadstring(game:HttpGet("https://rawscripts.net/raw/UPD-Blue-Lock:-Rivals-OP-FREE-SCRIPT-HITBOX-EXPANDER-ESP-AUTOFARM-27394"))();
	end);
	MainSection:NewButton("Run Blade Ball", "RobloxExploits", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/FFJ1/Roblox-Exploits/main/scripts/Loader.lua"))();
	end);
	MainSection:NewButton("Run CombatWarriors", "supported", function()
		loadstring(game:HttpGet("https://scriptblox.com/raw/Combat-Warriors-auto-parry-that-works-solara-supported-17089"))();
	end);
	MainSection:NewButton("Run arsenal", "wuhaz", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/wuhaz/arsenal/main/main.lua"))();
	end);
	MainSection:NewButton("Run Shrimp Game", "Autowin", function()
		loadstring(game:HttpGet("https://rawscripts.net/raw/PENTA-Shrimp-Game-Auto-win-27375"))();
	end);
	MainSection:NewButton("Run BloxFruitsV1", "TomTamHub", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/NongTham/TomTamHub/refs/heads/main/BF.lua"))();
	end);
	MainSection:NewButton("Run BloxFruitsV2", "Blox Fruit Dupe (Visual)", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/SpeedXHub/BloxFruits-FruitsDuper/refs/heads/main/BF-FD"))();
	end);
	MainSection:NewButton("Run BloxFruitsV3", "Raito Hub (Fisch)", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Efe0626/RaitoHub/refs/heads/main/Script"))();
	end);
	MainSection:NewButton("Run BloxFruitsV4", "Alchemy Hub", function()
		loadstring(game:HttpGet("https://scripts.alchemyhub.xyz"))();
	end);
	MainSection:NewButton("Run Criminality", "FemboysHubBoosr", function()
	...
	MainSection:NewButton("Run King Legacy", "ArcHub", function()
